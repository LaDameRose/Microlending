...
Regression Tree Prediction evaluated on rmse and % of cases with less than 25% error - log dataset
```{r}
...
rel_change_log_rt <- abs(errors_log_rt) / exp(comp_log_test$duration_perdollar)
pred25_log_rt <- table(rel_change_log_rt<0.25)["TRUE"] / nrow(comp_log_test)
paste("RMSE", rmse_log_rt)
paste("PRED(25)", pred25_log_rt)
```
