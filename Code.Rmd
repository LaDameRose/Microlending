...
Log-log transform and regression
```{r}
...
10-Fold Cross-validation to check overfitting - regular dataset
```{r}
...
10-Fold Cross-validation to check overfitting - normalized dataset
```{r}
...
10-Fold Cross-validation to check overfitting - log dataset
```{r}
...
prediction evaluated on rmse and % of cases with less than 25% error - log dataset
```{r}
